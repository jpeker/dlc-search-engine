...
public class JSpider20View extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = JSpider20App.getApplication().getMainFrame();
            aboutBox = new JSpider20AboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        JSpider20App.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(jspider20.JSpider20App.class).getContext().getActionMap(JSpider20View.class, this);
